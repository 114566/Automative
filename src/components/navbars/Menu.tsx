...
const Menu = ({ navClass, buttonClass, showDownload, loggedInUser }: MenuProps) => {
    ...
    return (
        <Nav as="ul" className={classNames('align-items-lg-center', navClass)}>
            ...
            <Nav.Item as="li">
                <NavLink to="/unternehmen" end className={classNames('nav-link', ({ ...isActive }) => isActive && 'active')}>
                    Unternehmen
                </NavLink>
            </Nav.Item>

            <Nav.Item as="li">
                <NavLink to="/kontakt" end className={classNames('nav-link', ({ ...isActive }) => isActive && 'active')}>
                    Kontakt
                </NavLink>
            </Nav.Item>

            <Nav.Item as="li">
                <NavLink to="/konditionen" end className={classNames('nav-link', ({ ...isActive }) => isActive && 'active')}>
                    Konditionen
                </NavLink>
            </Nav.Item>
            ...
            <Dropdown.Toggle
                    ...
                    className={classNames(
                        isActiveRoute('/other/portfolio/PortfolioGrid') ||
                            isActiveRoute('/other/portfolio/PortfolioItem') ||
                            isActiveRoute('/other/portfolio/PortfolioItem')
                            ? 'active'
                            : ''
                    )}
                >
                    Referenzen <FeatherIcon icon="chevron-down" className="d-inline-block icon icon-xxs ms-1 mt-lg-0 mt-1" />
                </Dropdown.Toggle>
                <Dropdown.Menu renderOnMount>
                    <Nav as={'ul'} navbar={false}>
                    <Nav.Item as="li">
                         <NavLink to="/projektkatalog" end className={classNames('nav-link', ({ ...isActive }) => isActive && 'active')}>
                             Projektkatalog
                    </NavLink>
                    </Nav.Item>
                        <Dropdown as={'li'} className="nav-item" aria-labelledby="navbarPages">
                            ...
                            >
                                Use Cases<div className="arrow"></div>
                            </Dropdown.Toggle>

...
const Hero8 = () => {
    return (
        <section className="position-relative bg-gradient3 overflow-hidden hero-7 pt-6 pb-4">
            <Container>
                <Row className="align-items-center text-center text-sm-start">
                    <Col lg={6}>
                        <h1 className="hero-title">
                            Speed up your{' '}
                            <span className="highlight highlight-success d-inline-block">performance</span>
                        </h1>
                        ...
                        <div className="py-5">
                            ...
                            <div className="rounded d-inline-block mt-3 py-1 px-3 alert bg-soft-primary">

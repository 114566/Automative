        ...
        <section className="position-relative hero-5 pb-4 pt-7 pb-sm-0 hero-with-shapes">
            ...
            <Container className="position-relative zindex-1">
                <Row className="align-items-center">
                    <Col lg={12}>
                        <div
                            className="rounded d-inline-block mb-4 px-3 py-2 alert bg-soft-primary"
                            data-aos="fade-right"
                            data-aos-duration="1000"
                        >
                            <Link to="#">
                                <div className="d-flex align-items-center">
                                    <Badge pill bg="primary" className="px-2 py-1">
                                        New!
                                    </Badge>
                        ...
                        <h1 className="hero-title fw-medium">
                            ...
                            <span className="highlight highlight-success d-inline-block">works</span>
                        </h1>

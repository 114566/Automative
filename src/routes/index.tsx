...
// unternehmen
const Unternehmen = React.lazy(() => import('../pages/other/Company'));

// Kontakt
const Kontakt = React.lazy(() => import('../pages/other/Contact'));

// Konditionen
const Konditionen = React.lazy(() => import('../pages/other/Pricing'));

// Portfolio
const Projektkatalog = React.lazy(() => import('../pages/other/portfolio/PortfolioGrid'));
const Risikobewertung =  React.lazy(() => import('../pages/other/portfolio/Portfolio_projekt1'));
const Kampagnenplanung =  React.lazy(() => import('../pages/other/portfolio/Portfolio_projekt2'));
...
const Impressum= React.lazy(() => import('../pages/other/Impressum'));
...
const Portfolio_projekt1 = React.lazy(() => import('../pages/other/portfolio/Portfolio_projekt1'));
const Portfolio_projekt2 = React.lazy(() => import('../pages/other/portfolio/Portfolio_projekt2'));
    ...
    return useRoutes([
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'unternehmen',
                    element: <LoadComponent component={Unternehmen} />,
                },
                {
                    path: 'kontakt',
                    element: <LoadComponent component={Kontakt} />,
                },
                {
                    path: 'konditionen',
                    element: <LoadComponent component={Konditionen} />,
                },
                {
                    path: 'projektkatalog',
                    element: <LoadComponent component={Projektkatalog} />,
                },
                {
                    path: 'risikobewertung',
                    element: <LoadComponent component={Risikobewertung} />,
                },
                {
                    path: 'kampagnenplanung',
                    element: <LoadComponent component={Kampagnenplanung} />,
                },
                {
                    path: 'impressum',
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        { path: 'impressum', element: <LoadComponent component={Impressum} /> },
                        { path: 'pricing', element: <LoadComponent component={Pricing} /> },
                        {
                            ...
                            children: [
                                ...
                                { path: 'projekt_1', element: <LoadComponent component={Portfolio_projekt1} /> },
                                { path: 'projekt_2', element: <LoadComponent component={Portfolio_projekt2} /> },
                            ],
                        },

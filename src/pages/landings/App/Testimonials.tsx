...
// component
import SwiperSlider4 from '../../../components/sliders/SwiperSlider4';
...
const Testimonials = () => {
    return (
        <section
            className="section pt-5 pb-6 py-sm-8 mb-5 mb-sm-0 bg-gradient7 position-relative"
            data-aos="fade-up"
        ...
        >
            ...
            <Container className="testimonials-1">
                <Row className="align-items-center">
                    <Col>
                        <Badge pill bg="" className="text-white px-2 py-1">
                            Testimonials
                        </Badge>
                        <h1 className="display-5 text-white fw-semibold">What people say</h1>
                    </Col>

...
const AuthLayout = ({ hasSlider, children, bottomLinks }: AuthLayoutProps) => {
    return (
        <div className="medium-gray-bg min-vh-100 align-items-center d-flex justify-content-center pt-2 pt-sm-5 pb-4 pb-sm-5">
            <Container>
                                        ...
                                        <div className="p-xl-5 p-3">
                                            <div className="mx-auto mb-5">
                                                <Link to="/" className="d-flex">
                                                    <Logo className="align-self-center" width={"102"} />
                                                </Link>
                                            </div>
                                            {children}
                                        </div>

            ...
            <Container>
                <Row className="justify-content-center">
                    <Col lg={7} className="text-center">
                        <h1 className="hero-title">Kampagnenplanung</h1>
                    </Col>
                </Row>
                ...
                <Row className="border-top border-bottom py-4 align-items-center mt-5">
                    <Col>
                        ...
                        <h4 className="mt-1 fw-medium">Fitness-Food Anbieter</h4>
                    </Col>
                    {/* <Col>
                        <span className="fs-14">Kategorie</span>
                        <h4 className="mt-1 fw-medium">Marketing</h4>
                    </Col> */}
                    <Col>
                        <span className="fs-14">Branche</span>
                        <h4 className="mt-1 fw-medium">Functional-Food</h4>
                    </Col>
                    <Col xs="auto">
                        <ul className="list-inline mb-0 me-3">
                            ...
                            <li className="list-inline-item align-middle">
                                <a href="https://www.linkedin.com/sharing/share-offsite/?url=localhost:3000/kampagnenplanung"><FeatherIcon icon="linkedin" className="icon-dual-info icon-l" /></a>
                            </li>
                        </ul>
                    </Col>
                    {/* <Col xs="auto">
